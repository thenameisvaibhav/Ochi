...
const Navbar = () => {
    return (
        <div className="w-full px-5 lg:px-14 py-4 font-['Neue_Montreal'] flex items-center justify-between fixed z-[999] backdrop-blur">
            <div className="logo">
            ...
            <div className="links lg:flex gap-6 hidden">
                {['Services', 'Our work', 'About us', 'Insights', 'Contact us'].map((item, index)=> (
                    <a key={index} href="#" className={`text-lg leading-6 ${index === 4 && 'ml-64'}`}>{item}</a>
                ))}
            </div>
            <div className="menu pt-1 lg:hidden">
                <svg className="nav-toggle lg:hidden" width="24" height="9" viewBox="0 0 24 9" fill="none" xmlns="http://www.w3.org/2000/svg">
